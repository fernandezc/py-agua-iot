...
API_LOGIN_APPLICATION_VERSION = "2.1.0.0"
...
class agua_iot(object):
    ...
    statusTranslated = {
        0: "OFF", 1: "DEMARRAGE", 2: "CHARGEMENT PELLET", 3: "ALLUMAGE FLAMME", 4: "DÉBUT CHAUFFE",
        5: "CHAUFFE", 6: "NETTOYAGE POT", 7: "ARRETÉ", 8: "ECO STOP",
